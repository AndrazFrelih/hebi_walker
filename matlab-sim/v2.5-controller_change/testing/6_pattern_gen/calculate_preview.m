function [Pctrl] = calculate_preview(zdes, Ts, Tini,Tsim)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Pctrl.par.Tini = Tini;   % preview time
    Pctrl.par.Tsim = Tsim;   % total simulation time
    ...
    %% System augmentation
    Pctrl.N_L = floor(Pctrl.par.Tini/Ts);         % length of preview: 2 seconds
