function [zmp_glo,zmpL,zmpR,stateL,stateR] = compute_zmp_full2(FSL, FSR, foot_data, Hw_eeL, Hw_eeR, thr, simpleZMP)
    ...
    if simpleZMP
        ...
        %origin points = Pedge
        %target points = Pmeas
        [~,zmp_L_glo,zmp_L_loc,stateL] = force_remapping(FmL, AinvX, AinvY, Apseud, Pm, Pe, Hw_eeL(1:3,1:3), Hw_eeL(1:3,4), thr, 't');
        [~,zmp_R_glo,zmp_R_loc,stateR] = force_remapping(FmR, AinvX, AinvY, Apseud, Pm, Pe, Hw_eeR(1:3,1:3), Hw_eeR(1:3,4), thr, 't');
    end
