...
// System constants
#define deltat 0.002f // sampling period in seconds (shown as 2 ms - 500Hz)
...
void filterUpdate(double *w, double *a, double *q, double *qold)
{
    ...
    double SEq_1 = qold[0], SEq_2 = qold[1], SEq_3 = qold[2], SEq_4 = qold[3]; // estimated orientation quaternion elements with initial conditions
